...
\begin{document}
    ...
    \input{chapters/flyMode.tex}
    \clearpage
    \input{chapters/uorb.tex}
    \clearpage
    \input{chapters/navigator.tex}
    \clearpage
    \input{chapters/positionController.tex}
    \clearpage
    \input{chapters/attitudeController.tex}
    \clearpage
    \input{chapters/raspberry.tex}
    \clearpage
    \input{chapters/linuxLearning.tex}
    \clearpage
    \input{chapters/ros.tex}
    \clearpage
    \input{chapters/pre_knowledge.tex}
\end{document}
